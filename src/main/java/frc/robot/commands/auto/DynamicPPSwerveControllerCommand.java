...
public class DynamicPPSwerveControllerCommand extends CommandBase {
  ...
  private static BiConsumer<Translation2d, Rotation2d> logError =
      DynamicPPSwerveControllerCommand::defaultLogError;

  /**
   * Constructs a new DynamicPPSwerveControllerCommand that when executed will follow the provided
   ...
   */
  public DynamicPPSwerveControllerCommand(
    ...
    if (useAllianceColor
        && trajectory.get().fromGUI
        && trajectory.get().getInitialPose().getX() > 8.27) {
  ...
  public void initialize() {
    if (useAllianceColor && trajectorySupplier.get().fromGUI) {
      transformedTrajectory =
          PathPlannerTrajectory.transformTrajectoryForAlliance(
              trajectorySupplier.get(), DriverStation.getAlliance());
    } else {
      transformedTrajectory = trajectorySupplier.get();
    }
  ...
  private static void defaultLogError(Translation2d translationError, Rotation2d rotationError) {
    SmartDashboard.putNumber(
        "DynamicPPSwerveControllerCommand/xErrorMeters", translationError.getX());
    SmartDashboard.putNumber(
        "DynamicPPSwerveControllerCommand/yErrorMeters", translationError.getY());
    SmartDashboard.putNumber(
        "DynamicPPSwerveControllerCommand/rotationErrorDegrees", rotationError.getDegrees());
  }
   ...
   *     active path. This will be called whenever a DynamicPPSwerveControllerCommand starts
  ...
  public static void setLoggingCallbacks(
    ...
    DynamicPPSwerveControllerCommand.logActiveTrajectory = logActiveTrajectory;
    DynamicPPSwerveControllerCommand.logTargetPose = logTargetPose;
    DynamicPPSwerveControllerCommand.logSetpoint = logSetpoint;
    DynamicPPSwerveControllerCommand.logError = logError;
  }
}
