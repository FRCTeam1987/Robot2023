...
public class CompRobotConfig extends RobotConfig {
  ...
  private static final double DRIVE_KS = 0.25239;
  private static final double DRIVE_KV = 2.27890;
  ...
  private static final double AUTO_MAX_ACCELERATION_METERS_PER_SECOND_SQUARED = 3.0;
  ...
  private static final double AUTO_TURN_D_CONTROLLER = 0.1;
