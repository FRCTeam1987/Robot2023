...
public class SwerveModuleFactory<DC, SC> {
  ...
  public SwerveModule create(
    ...
    return new ModuleImplementation(driveController, steerController, moduleId);
  }

  public SwerveModule create(DC driveConfiguration, SC steerConfiguration, int moduleId) {
  ...
  public SwerveModule create(
    ...
    return new ModuleImplementation(driveController, steerContainer, moduleId);
  }

  public SwerveModule create(
      ShuffleboardLayout container, DC driveConfiguration, SC steerConfiguration, int moduleId) {
    var driveController =
  ...
  private static class ModuleImplementation implements SwerveModule {
    ...
    private ModuleImplementation(
        DriveController driveController, SteerController steerController, int moduleId) {
